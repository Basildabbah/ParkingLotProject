...
public class Displayreportofmanager {
    ...
    void initialize() {
        ...
        parking_id1.setText(idd_parking_lot);
        parking_id1.setDisable(true);
        parking_id.setText(idd_parking_lot);
        parking_id.setDisable(true);
    }
